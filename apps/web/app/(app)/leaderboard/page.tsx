    ...
    <div className="space-y-8 animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="p-6 bg-rose-500/10 border border-rose-500/25 text-rose-400 rounded-2xl max-w-xl mx-auto text-center">
          ...
          <button onClick={fetchLeaderboard} className="mt-3 text-xs bg-rose-500 text-white px-4 py-2 rounded-xl font-bold">
            Retry Connection
          </button>
        </div>
      ) : leaderboard.length === 0 ? (
        <div className="text-center py-20 glass-panel border border-white/5 border-dashed rounded-2xl max-w-xl mx-auto">
          <p className="text-sm font-bold text-white/60">Scoreboard is empty</p>
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end pt-4">
            ...
            {leaderboard[1] && (
              <div className="glass-card rounded-2xl p-6 border border-white/5 flex flex-col items-center gap-4 text-center order-2 md:order-1 md:h-[220px] justify-center relative">
                <div className="absolute top-3 left-3 flex items-center justify-center w-7 h-7 rounded-lg bg-slate-400/10 text-slate-400">
                ...
                <div className="flex gap-4 border-t border-white/5 pt-3 w-full justify-center text-xs">
                  ...
                  <div>
                    <span className="font-extrabold text-yellow-400 flex items-center gap-0.5 justify-center">
            ...
            {/* Podium Spot 1: Gold */}
            {leaderboard[0] && (
              <div className="glass-panel rounded-2xl p-8 border-2 border-yellow-400/20 flex flex-col items-center gap-4 text-center order-1 md:order-2 md:h-[260px] justify-center relative shadow-2xl shadow-yellow-500/5">
                <div className="absolute -top-4 bg-gradient-to-r from-yellow-500 to-amber-400 text-slate-900 font-extrabold text-[10px] uppercase tracking-wider px-3.5 py-1 rounded-full flex items-center gap-1 shadow-lg">
                ...
                <img
                  ...
                  className="w-18 h-18 rounded-full border-4 border-yellow-400 object-cover"
                />
                <div>
                ...
                <div className="flex gap-6 border-t border-white/5 pt-4.5 w-full justify-center text-sm">
                  ...
                  <div>
                    <span className="font-black text-yellow-400 flex items-center gap-0.5 justify-center text-base">
            ...
            {leaderboard[2] && (
              <div className="glass-card rounded-2xl p-6 border border-white/5 flex flex-col items-center gap-4 text-center order-3 md:h-[200px] justify-center relative">
                <div className="absolute top-3 left-3 flex items-center justify-center w-7 h-7 rounded-lg bg-amber-700/10 text-amber-600">
                  <Medal className="w-4 h-4" />
                </div>
                <img
          ...
          {leaderboard.length > 3 && (
            <div className="glass-panel border border-white/5 rounded-2xl overflow-hidden mt-6">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse text-xs">
                  <thead>
                    <tr className="border-b border-white/5 bg-white/[0.01] text-white/45 font-bold uppercase tracking-wider">
                      ...
                      return (
                        <tr key={user.id} className="hover:bg-white/[0.01] transition-all">
                          ...
                          <td className="px-6 py-4.5 text-center">
                            <div className="inline-flex items-center gap-1 font-bold text-yellow-400">
                              <Star className="w-3.5 h-3.5 fill-yellow-400" />
