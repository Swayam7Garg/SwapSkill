    ...
    <div className="glass-panel border border-white/5 rounded-2xl p-6 space-y-6">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <label className="text-xs font-semibold text-white/55 flex items-center gap-1.5">
            <SlidersHorizontal className="w-3.5 h-3.5 text-accent animate-pulse" />
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-semibold shrink-0 transition-all border ${
                  isSelected
                    ? "bg-gradient-to-r from-primary to-secondary text-white border-transparent shadow-lg shadow-primary/20 scale-[1.02] hover:shadow-[0_0_15px_rgba(255,0,127,0.3)]"
                    : "bg-background/40 border-white/5 text-white/60 hover:text-white hover:border-accent/40"
                }`}
              >
                {cat.label}
              </button>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-background border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-xs text-white placeholder-white/30 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent"
            />
          </div>
        </div>
